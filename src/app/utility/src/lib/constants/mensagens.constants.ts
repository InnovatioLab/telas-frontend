export const MENSAGENS: MensagensConstants = {
  dialogo: {
    ...
    cancelarEditar: 'Are you sure you want to cancel? All<br/>information filled will be lost.',
    cancelarEditarMobile: 'Are you sure you want to cancel?<br/>All information filled will be lost.',
    ...
    cancelar: 'Are you sure you want to leave? This action will discard all data filled in the form.',
    ...
    identificationNumberNotFound: 'Identification number not found! Please check the information and try again.',
    recusarTermo: 'By not accepting the Terms of Acceptance, you<br/> will be prevented from logging into the system.',
    recusarTermoMobile: 'By not accepting the Terms of<br/>Acceptance, you will be prevented <br/> from logging into the system.',
...
export interface MensagensConstants {
  dialogo: {
    ...
    identificationNumberNotFound: string;
    recusarTermo: string;
